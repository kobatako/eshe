defmodule Eshe.Pipeline do
  ...
  defp do_pipe(identifier, attrs, context) do
    quote do
      ...
      loaded = Eshe.Pipeline.__load__(__MODULE__, @change_pipeline_record)
